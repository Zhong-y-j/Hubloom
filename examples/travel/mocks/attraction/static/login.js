(function () {
  const STORAGE = {
    token: "attraction_demo_token",
    user: "attraction_demo_user",
    swaggerUrl: "attraction_mcp_swagger_url",
    baseUrl: "attraction_mcp_base_url",
    authScheme: "attraction_mcp_auth_scheme",
  };
