"""Prime Hubloom MCP with attraction OpenAPI after both services are up."""
...
ATTRACTION_PUBLIC_URL = os.getenv(
    "ATTRACTION_PUBLIC_URL", "http://127.0.0.1:9004"
).rstrip("/")

_PRIME_PAYLOAD = {
    "mcp_swagger_url": f"{ATTRACTION_PUBLIC_URL}/openapi.json",
    "mcp_base_url": ATTRACTION_PUBLIC_URL,
    "mcp_auth_scheme": "Bearer",
}


async def prime_hubloom() -> bool:
    """Register attraction Swagger with Hubloom. Returns True on success."""
    try:
