(function () {
  const STORAGE = {
    token: "hotel_demo_token",
    user: "hotel_demo_user",
    swaggerUrl: "hotel_mcp_swagger_url",
    baseUrl: "hotel_mcp_base_url",
    authScheme: "hotel_mcp_auth_scheme",
  };
