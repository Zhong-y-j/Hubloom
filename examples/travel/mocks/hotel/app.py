...
from .routers import auth, bookings, hotels, rooms, users
...
app = FastAPI(
    title="Hubloom Travel Hotel API",
    description="差旅演示案例：酒店预订 mock 系统（SQLite 存储）",
    version="0.1.0",
)
...
def health() -> dict[str, str]:
    return {"status": "ok", "service": "travel-hotel"}
